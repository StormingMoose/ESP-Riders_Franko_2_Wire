...
LMotorController2 motorController(ENA, IN1,  ENB, IN3,  1, 1);
...
void setup()
{
    ...
    mpu.setXGyroOffset(370);
    mpu.setYGyroOffset(93);
    mpu.setZGyroOffset(1);
    mpu.setZAccelOffset(2812); // 1688 factory default for my test chip
    ...
    if (devStatus == 0)
    {
        ...
        Serial.println(F("Enabling interrupt detection (Arduino external interrupt 10)..."));
