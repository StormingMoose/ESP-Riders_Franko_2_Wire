...
LMotorController2::LMotorController2(int ena, int in1, int enb, int in3, double motorAConst, double motorBConst)
{
...
void LMotorController2::move(int leftSpeed, int rightSpeed, int minAbsSpeed)
{
    if (rightSpeed < 0)
    {
...
void LMotorController2::move(int speed, int minAbsSpeed)
{
    int direction = 1;
...
void LMotorController2::move(int speed)
{
    if (speed == _currentSpeed) return;
...
void LMotorController2::turnLeft(int speed, bool kick)
{
...
void LMotorController2::turnRight(int speed, bool kick)
{
...
void LMotorController2::stopMoving()
{
    digitalWrite(_in1, LOW);
